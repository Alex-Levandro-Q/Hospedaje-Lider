  ...
  const fetchUserProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setUsuario(data);
        setDocumentData({
          fotoCarnetFrente: data.fotoCI1 || '',
          fotoCarnetReverso: data.fotoCI2 || ''
        });
      }
    } catch (error) {
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-6 relative">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white">
                  <h1 className="text-xl font-bold">{usuario?.nombre} {usuario?.apellidos}</h1>
              ...
              {activeTab === 'documents' && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    {/* Frente del Carnet */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Frente del Carnet</label>
                        ...
                        {documentData.fotoCarnetFrente ? (
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-1">
                              ...
                              >
                                <FiEye size={12} className="inline mr-1" /> Ver
                              </button>
                              <button
                                type="button"
                              ...
                              >
                                <FiX size={12} className="inline mr-1" /> Quitar
                              </button>
                            </div>
                          </div>
                        ) : (
                          <div className="text-center">
                            ...
                            <label
                              ...
                              className="cursor-pointer bg-orange-500 text-white px-3 py-1 rounded text-xs hover:bg-orange-600 inline-block mt-2"
                            >
                              Subir
                            </label>
                          </div>
                    ...
                    {/* Reverso del Carnet */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Reverso del Carnet</label>
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-3">
